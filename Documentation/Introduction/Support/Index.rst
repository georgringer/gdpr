...
Need Support?
=============
There are various ways to get support for EXT:gdpr!

Stackoverflow
-------------
Please use https://stackoverflow.com to get best support. Tags you should use are `typo3` and `tx-gdpr`, so your question will be visible at http://stackoverflow.com/questions/tagged/tx_gdpr.

Slack
-----
A dedicated channel on slack can be be used to get in touch with other users!

The url is: https://typo3.slack.com/messages/ext-gdpr/
